...
export default function modelIdentityExtension(pi: ExtensionAPI) {
       ...
       pi.on("before_agent_start", async (_event, ctx) => {
              ...
              else if (label !== lastInjectedLabel)
                     reason = "model was switched";
              else if (forceNextInject) reason = "model was switched";
              else if (needsPostCompactionInject)
       ...
       pi.registerTool({
              ...
              description:
                     "Show the live model identifier pi is currently running, as seen by the runtime.",
              ...
              execute: async (_id, _params, _signal, _onUpdate, ctx) => {
                     ...
                     return {
                            ...
                            details: { label, id: m.id, provider: m.provider },
                     };
              },
       });
}
